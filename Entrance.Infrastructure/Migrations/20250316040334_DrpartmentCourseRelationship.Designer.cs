...
namespace Entrance.Infrastructure.Migrations
{
    ...
    [Migration("20250316040334_DrpartmentCourseRelationship")]
    partial class DrpartmentCourseRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.AcademicBackground", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Applicant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Campus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.CounselorConsultation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.EmergencyContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Examination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.FamilyRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.FirstApplicationInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Interview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.ParentGuardianInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PersonalInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PersonalityProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PhysicalHealth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PsychiatristConsultation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PsychologistConsultation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.SoloParent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Spouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Transfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Infrastructure.Models.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.AcademicBackground", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        .WithOne("AcademicBackground")
                        .HasForeignKey("Entrance.Domain.Entities.AcademicBackground", "ApplicantId")
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Applicant", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Schedule", "Schedule")
                        .WithMany("Applicants")
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.CounselorConsultation", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.CounselorConsultation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Course", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Campus", "Campus")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.EmergencyContact", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.EmergencyContact", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Examination", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        .WithOne("Examination")
                        .HasForeignKey("Entrance.Domain.Entities.Examination", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.FirstApplicationInfo", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.FirstApplicationInfo", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.ParentGuardianInformation", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.ParentGuardianInformation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PersonalInformation", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.PersonalInformation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PersonalityProfile", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.PersonalityProfile", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PhysicalHealth", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.PhysicalHealth", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PsychiatristConsultation", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.PsychiatristConsultation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.PsychologistConsultation", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Entrance.Domain.Entities.PsychologistConsultation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.SoloParent", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        .WithOne("SoloParent")
                        .HasForeignKey("Entrance.Domain.Entities.SoloParent", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entrance.Domain.Entities.Spouse", b =>
                {
                    b.HasOne("Entrance.Domain.Entities.Applicant", "Applicant")
                        .WithOne("Spouse")
                        .HasForeignKey("Entrance.Domain.Entities.Spouse", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Entrance.Infrastructure.Models.ApplicationUser", null)
                        .WithMany()
