...
namespace Entrance.Shared.Tool;
public static class Utility
{
    ...
    public static string FullName(ApplicantResponse? model, ApplicantPassersListResponse? passers)
    {
        if (model != null)
        {
        ...
        if (passers != null)
        {
            var lastName = passers.PersonalInformation.LastName;
            var firstName = passers.PersonalInformation.FirstName;
            var nameExtension = passers.PersonalInformation.NameExtension;

            // Get the first character if MiddleName exists and has at least one character
            var middleNameInitial = passers.PersonalInformation.MiddleName?.Length > 0
                ? model.PersonalInformation.MiddleName[0] + "."
                : string.Empty;
    ...
    public static string CourseTrimmedName(ApplicantResponse model)
    {
    ...
    public static string ExaminationResult(ApplicantResponse? model, ApplicantPassersListResponse? passers)
    {
        if (model != null)
        {
            if (model.Examination != null)
            {
                return Assessment.ExaminationResult(model.Examination.ReadingRawScore, model.Examination.MathRawScore,
                model.Examination.ScienceRawScore, model.Examination.IntelligenceRawScore).ToString();
            }
        }
        ...
        if (passers != null)
        {
            if (passers.Examination != null)
            {
                return Assessment.ExaminationResult(passers.Examination.ReadingRawScore, passers.Examination.MathRawScore,
                passers.Examination.ScienceRawScore, passers.Examination.IntelligenceRawScore).ToString();
            }
        }
        return "Not Recorded";
    }
    ...
    public static string InterviewResult(ApplicantResponse? model, ApplicantPassersListResponse? passers)
    {
        if (model != null)
        {
            if (model.Interviews != null && model.Interviews.Any(x => x.IsUse))
            {
                var firstInterview = model.Interviews.First(x => x.IsUse);
        ...
        if (passers != null)
        {
            if (passers.Interviews != null && passers.Interviews.Any(x => x.IsUse))
            {
                var firstInterview = passers.Interviews.First(x => x.IsUse);
                return Assessment.InterviewResult(firstInterview.InterviewReading, firstInterview.InterviewCommunication, firstInterview.InterviewAnalytical, passers.GWA ?? 0).ToString();
            }
        }

        return "Not Recorded";
    }
    public static string OverallTotalRating(ApplicantResponse? model, ApplicantPassersListResponse? passers)
    {
        if (model != null)
        {
            if (model.Examination != null && model.Interviews != null && model.Interviews.Any(x => x.IsUse))
            {
                var firstInterview = model.Interviews.First(x => x.IsUse);
        ...
        if (passers != null)
        {
            if (passers.Examination != null && passers.Interviews != null && passers.Interviews.Any(x => x.IsUse))
            {
                var firstInterview = passers.Interviews.First(x => x.IsUse);
                return Assessment.OverallTotalRating(passers.Examination.ReadingRawScore, passers.Examination.MathRawScore, passers.Examination.ScienceRawScore, passers.Examination.IntelligenceRawScore,
                    firstInterview.InterviewReading, firstInterview.InterviewCommunication, firstInterview.InterviewAnalytical, passers.GWA ?? 0).ToString();
            }
        }

        return "Incomplete Data";
    }
    public static string Remarks(ApplicantResponse? model, ApplicantPassersListResponse? passers)
    {
        if (model != null)
        {
            if (model.Examination != null && model.Interviews != null && model.Interviews.Any(x => x.IsUse) && model.GWA != null)
            {
                var firstInterview = model.Interviews.First(x => x.IsUse);
        ...
        if (passers != null)
        {
            if (passers.Examination != null && passers.Interviews != null && passers.Interviews.Any(x => x.IsUse) && passers.GWA != null)
            {
                var firstInterview = passers.Interviews.First(x => x.IsUse);
                return Assessment.Remarks(passers.Examination.ReadingRawScore, passers.Examination.MathRawScore, passers.Examination.ScienceRawScore, passers.Examination.IntelligenceRawScore,
                    firstInterview.InterviewReading, firstInterview.InterviewCommunication, firstInterview.InterviewAnalytical, passers.GWA ?? 0).ToString();
            }
        }
